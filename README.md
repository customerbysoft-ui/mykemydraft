  ...
  <style>
    ...
    * {
    ...
    header {
      ...
      position: relative;
      overflow: hidden;
      background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.9)), url('https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?auto=format&fit=crop&w=1600&q=80');
    ...
    /* Portfolio Section */
    .portfolio {
      background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=1600&q=80');
      background-size: cover;
    ...
    /* Footer */
    footer {
      background: linear-gradient(to bottom, rgba(0,0,0,0.95), rgba(10,10,26,1));
      padding: 80px 0 30px;
      text-align: center;
      margin-top: 80px;
    }
